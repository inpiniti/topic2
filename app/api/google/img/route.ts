...
export async function GET(request: NextRequest) {
  ...
  const query = {
    q: String(word),
    sca_esv: "4641ef0b18f4d6ad",
    rlz: "1C1CHBD_koKR1028KR1028",
    udm: "2",
    biw: "706",
    bih: "1047",
    sxsrf: "ADLYWILVL1gLsyvYmZEKPpdPTuz8Ouk6UA:1736444809124",
    ei: "iQuAZ9-fB5uOvr0PqcTXmQs",
    ved: "0ahUKEwifiJSAmemKAxUbh68BHSniNbMQ4dUDCBE",
    uact: "5",
    oq: String(word),
    gs_lp:
      "EgNpbWciG-q5gOuvvOyghCBzaXRlOmRjaW5zaWRlLmNvbUjslgRQAFgAcAJ4AJABAJgBkQGgAZEBqgEDMC4xuAEDyAEAmAIAoAIAmAMAiAYBkgcAoAct",
    sclient: "img",
  };
